...
export function Habit() {
    ...
    async function fetchHabits() {
        try {
            ...
            console.log(error);
            Alert.alert('Ops!', 'Não foi possível recuperar as informações dos hábitos.')
        } finally {
            setLoading(false);
        }
    }
    ...
    async function handleToggleHabit(habitId: string) {
        try {
            ...
            Alert.alert('Ops!', 'Não foi possível atualizar o status do hábito. Tente novamente mais tarde.')
        }
    }
